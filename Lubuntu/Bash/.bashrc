...
PS1="\n[~\[\033\w]\[\033[0m\]\n\[\033[1;33m\]\u\[\033[1;33m\]->\[\033[00m\] \[\033[0m\]"
...
export PROMPT_COMMAND='__git_ps1 "[~\[\033\w]\[\033[0m\]\n\[\033[1;33m\]\u\[\033[1;33m\]->\[\033[00m\] \[\033[0m\]" " "'
...
function set_bash_prompt () {
    ...
    PS1="${PYTHON_VIRTUALENV}[${debian_chroot:+($debian_chroot)}${WHITE}\w\[\033[00m\]] ${WHITE}\n\u-> ${RED}$(git_branch)$(hg_branch)${COLOR_NONE} "
}
